  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Vehicle No. Support", value: "vehicle_registration" , width: '150px' , height: '150px'},

        { text: "Contract Type", value: "type" , width: '150px', height: '150px'},
        { text: "Agreement Number", value: "agreement_number" , width: '150px', height: '150px'},

        //{ text: "Next Step", value: "next_step" },
        { text: "Status Mobil", value: "status_next_step" , width: '150px', height: '150px'},
